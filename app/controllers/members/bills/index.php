...
class IndexController extends BillsController {
    ...
    public function index() {
        ...
        foreach ($data['rows'] as $key => $value) {
            $path = $this->relative_path_attachments_documents . 'bill_' . $value['id_bill'] . '/';
    ...
    public function _loadDataFromModel() {
        ...
        return $this->_Model->loadBills($wheres, $filters, $limits);
    }
