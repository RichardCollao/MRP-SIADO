...
class IndexController extends UsersController {
    ...
    public function filters() {
        ...
        $this->Filter->setHeaders(array('Obra', 'Nombre', 'Correo', 'Estado'));
        $this->Filter->addFieldSelect('fk_id_establishment', array('field' => 'fk_id_establishment', 'options' => $this->list_establishments));
