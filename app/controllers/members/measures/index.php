...
class IndexController extends MeasuresController {
    ...
    public function filters() {
        ...
        $this->Filter->setHeaders(array('Abreviacion', 'Terminologia'));
        $this->Filter->addFieldInput('abbreviation', array('field' => 'abbreviation'));
        $this->Filter->addFieldInput('terminology', array('field' => 'terminology'));
    ...
    public function _loadDataFromModel() {
        ...
        return $this->_Model->loadMeasures($wheres, $filters, $limits);
    }
