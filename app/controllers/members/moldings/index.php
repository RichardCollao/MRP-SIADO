...
class IndexController extends MoldingsController {
    ...
    public function filters() {
        ...
        $this->Filter->setHeaders(array('Nombre', 'Proveedor', 'Número CC'));
        $this->Filter->addFieldInput('name', array('field' => 'moldings.name'));
        $this->Filter->addFieldInput('provider', array('field' => 'providers.name'));
    ...
    public function _loadDataFromModel() {
        ...
        return $this->_Model->loadMoldings($wheres, $filters, $limits);
    }
    ...
    private function _view($data) {
        ...
        $data['link_pieces'] = path::urlDomain('./pieces/');
