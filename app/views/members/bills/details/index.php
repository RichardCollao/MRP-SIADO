<h3>Detalle Factura N° <?php echo $data['bill']['number']; ?></h3>
<hr />
<div class="row">
    <div class="col-lg-12">
        ...
        <?php foreach ($data['rows'] as $row): ?>
            <tr class="force-one-row">
                ...
                <td style="text-align: right;">
                    <?php echo HelperWebIconFontAwesome::btnDetail($data['link_edit'] . $row['id_bill_detail']); ?>
                    &nbsp;
                    <?php echo HelperWebIconFontAwesome::btnDelete($data['link_delete_item'] . $row['id_bill_detail']); ?>
                </td>
            </tr>
        <?php endforeach; ?>
        <tr>
