<h3>Editar detalle en Orden de compra N° <?php echo $data['purchase_order']['number']; ?></h3>
<hr />
<div class="row">
    <div class="col-lg-12">
        <form role="form" method="post" action="<?php echo $data['action_form']; ?>">
            <table style="width: 100%">
                ...
                <tr class="force-one-row" >
                    ...
                    <td style="padding:5px">
                        <input id="fk_id_material" name="fk_id_material" style="width: 100%" class="form-control fake-select" />
                    </td>
                    <td style="padding:5px">
